        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
          <div className="lg:w-1/2 space-y-2">
            ...
            <div className="flex gap-8">
              <button className="bg-[#003459] hover:bg-[#003459]/90 text-[#FFFFFF] dark:bg-[#ADEBFF] dark:hover:bg-[#ADEBFF]/90 dark:text-[#003459] px-6 py-3 rounded-lg text-lg">
                Get Started
              </button>
              <button className="border border-[#003459] text-[#003459] hover:bg-[#ADEBFF]/20 dark:border-[#ADEBFF] dark:text-[#ADEBFF] dark:hover:bg-[#003459]/20 px-6 py-3 rounded-lg text-lg">
                Learn More
              </button>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="border border-[#ADEBFF] hover:border-[#003459] dark:hover:border-[#ADEBFF] transition-all duration-300 p-8 bg-[#FFFFFF]/50 dark:bg-[#00171F]/50 backdrop-blur-sm rounded-lg">
      ...
      <div className="container mx-auto px-4 py-24">
        <div className="bg-gradient-to-r from-[#ADEBFF]/20 to-[#003459]/20 dark:from-[#00171F]/20 dark:to-[#003459]/20 rounded-3xl p-12 backdrop-blur-sm">
          <div className="text-center max-w-3xl mx-auto space-y-8">
            ...
            <button className="bg-[#003459] hover:bg-[#003459]/90 text-[#FFFFFF] dark:bg-[#ADEBFF] dark:hover:bg-[#ADEBFF]/90 dark:text-[#003459] px-8 py-6 rounded-lg text-lg">
              Start Free Trial
            </button>
          </div>
        </div>
