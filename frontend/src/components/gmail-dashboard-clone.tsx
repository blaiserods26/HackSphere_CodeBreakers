...
export default function GmailDashboard() {
  ...
  return (
    <div className="h-screen flex flex-col">
      {/* Top Header */}
      <header className="h-[76px] px-6 py-4 flex items-center justify-between border-b border-gray-200">
        <div className="flex items-center space-x-4">
          <Menu className="w-6 h-6 text-gray-600" />
          <img src="/api/placeholder/92/30" alt="Gmail" className="h-8" />
        </div>
        ...
        <div className="flex-1 max-w-2xl px-4">
          <div className="flex items-center bg-gray-100 rounded-lg px-4 py-2">
            ...
            <input
              ...
              className="bg-transparent border-none focus:outline-none flex-1 ml-2"
            />
          </div>
        </div>
        ...
        <div className="w-64 p-4 border-r border-gray-200">
          ...
          <div className="space-y-1">
            <button className="flex items-center space-x-3 px-6 py-2 rounded-r-full w-full hover:bg-gray-100 bg-blue-50 text-blue-600">
              ...
              <span>Inbox</span>
              <span className="ml-auto text-sm">2,555</span>
            </button>
